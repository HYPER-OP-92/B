...
API_ID = int(getenv("API_ID", "0")) # Yahan apni API_ID daalein
...
# IMPORTANT: Fix for ImportError (cannot import name 'SUPPORT_GROUP')
SUPPORT_GROUP = getenv("SUPPORT_CHAT", "https://t.me/NOBITA_SUPPORT")
...
# Empty dicts and filters for the bot to function
