...
from BIGFM.core.call import Aviax, autoend, counter
from BIGFM.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
                ...
                async for i in client.get_dialogs():
                    if i.chat.type in [
                        ...
                        if (
                            ...
                            and i.chat.id != -1001511253627 and i.chat.id != -1002223516578 and i.chat.id != -1001511253627
                        ):
                            if left == 20:
                                continue
